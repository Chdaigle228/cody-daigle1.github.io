...
function beginsWith(string, char) {
    // YOUR CODE BELOW HERE //
    //determine if string starts with character
    if(string.charAt().toUpperCase() === char.toUpperCase()){
        //return true
        return true;
        //else return false
    } else{
...
function endsWith(string, char) {
    ...
    //determine if last character is equal to char
    if(upper.slice(-1) === char.toUpperCase()){
    //return true if so
    return true;
      //else return false
    } else {
